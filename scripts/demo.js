...
async function runDemo() {
  try {
    ...
    console.log('  - User: Alice wants to move 1 TOKEN from Ethereum to Cosmos');
    console.log('  - Amount: 1.0 TOKEN (1000000000000000000 wei)');
    console.log('  - Destination: cosmos1abc123...\n');

    console.log('📝 Demo Steps:');
    console.log('  1. 🔐 Alice approves TOKEN spending');
    console.log('  2. 🔒 Alice locks 1 TOKEN in bridge contract');
    console.log('  3. 📡 Relayer detects lock event');
    console.log('  4. ⚡ Relayer triggers mint on Cosmos');
    console.log('  5. ✨ Alice receives 1 wrapped TOKEN on Cosmos\n');
